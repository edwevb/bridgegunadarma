	            ...
	            <form method="post" action="{{ url('/masterpoint/'.$masterpoint->id) }}" enctype="multipart/form-data">
	              ...
	              <div class="row">
		              <div class="form-group col-md-4">
		                ...
		                <input type="number" name="discipline" id="discipline" class="form-style-static @error('discipline') is-invalid @enderror" step="0.01" min="0.1" value="{{$masterpoint->discipline}}" autocomplete="off">
		                @error('discipline')
		              ...
		              <div class="form-group col-md-4">
		                ...
		                <input type="number" name="bidding" id="bidding" class="form-style-static @error('bidding') is-invalid @enderror" step="0.01" value="{{$masterpoint->bidding}}" autocomplete="off">
		                @error('bidding')
		                  <div class="invalid-feedback">
		                    {{$message}}
		                  </div>
		              ...
		              <div class="form-group col-md-4">
		                ...
		                <input type="number" name="play" id="play" class="form-style-static @error('play') is-invalid @enderror" step="0.01" value="{{$masterpoint->play}}" autocomplete="off">
		                @error('play')
		                  <div class="invalid-feedback">
		                    {{$message}}
		                  </div>
