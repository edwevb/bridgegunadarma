      ...
      <div class="container">
        <div class="card-borderless">
          <div class="card-header">
            <h1 class="text-center font-weight-bold text-info">Atlet Bridge Gunadarma</h1>
          </div>
          <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <div class="mb-2">
              <a id="btn-wh" class="btn bg-gradient-info" data-toggle="modal" data-target="#modal-tambah-atlet"><i class="far fa-plus-square"></i> Tambah data</a>
              <a id="btn-wh" href="{{ url('/atlet/exportPdf') }}" target="__blank" class="btn bg-gradient-danger"><i class="fas fa-file-pdf"></i> Export PDF</a>
