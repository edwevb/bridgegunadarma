      ...
      <div class="container-fluid">
        <div class="card-borderless">
          <div class="card-header">
            <h1 class="text-center font-weight-bold text-info">Prestasi Bridge Gunadarma</h1>
          </div>
          <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <div class="mb-2">
              <a id="btn-wh" class="btn bg-gradient-info" data-toggle="modal" data-target="#modal-tambah-prestasi"><i class="far fa-plus-square"></i> Tambah data</a>
