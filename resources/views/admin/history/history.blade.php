	...
	<div class="row no-gutters">
		...
		<div class="col-lg d-flex">
          ...
          <div class="card-header">
            <h1 id="cms-header" class="text-center font-weight-bold">Pelatihan Bridge Gunadarma</h1>
          </div>
          <div class="card-body">
            @if ($errors->any())
            ...
            @endif
            <div class="mb-2">
              <a id="btn-wh" class="btn bg-primary" data-toggle="modal" data-target="#modal-tambah-history"><i class="far fa-plus-square"></i> Tambah data</a>
