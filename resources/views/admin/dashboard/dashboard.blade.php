  ...
  <div class="row no-gutters">
    ...
    <div class="col-lg d-flex">
      ...
      @if (session('AlertSuccess'))
        <div class="alert alert-success alert-dismissible text-center fade show col-md-8 mx-auto" role="alert">
      ...
      @else
        <div class="p-3">
          <h1><i class="fas fa-user"></i> Selamat datang, {{auth()->user()->name}}</h1>
          <hr class="myHr">
          <h3 class="p-2"><i class="fas fa-bullhorn"></i> Announcement!</h3>
          <div class="card borderless bg-gradient-purple text-white DashboardAnnouncement">
            <div class="card-body">
