	    ...
	    <div class="col-lg d-flex">
	      <div class="container">
	        ...
	        <div class="text-center mt-5">
	        	<a href="{{ url('/moreAtlet') }}" class="btn btn-salmon btn-none rounded-pill col-md-4 shadow"><span class="lead font-weight-bold text-white">Load More <i class="fas fa-users"></i></span></a>
	        </div>
	      </div> {{-- end container --}}
	    </div> {{-- end content --}}
	  </div>
