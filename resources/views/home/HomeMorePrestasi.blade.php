					...
					<div class="px-1 mb-5 morePrestasi">
					  <div class="card-borderless shadow h-100 bg-gradient-purple rounded morePrestasiShow">
					  	<div class="col-md p-2">
					  		<img height="250" width="auto" src="{{ asset('assets/img/img_pre/'.$prestasi->img_pre) }}" class="card-img-top rounded text-white" alt="{!!$prestasi->pre_title!!}">
					  	</div>
					    <div class="card-body text-white">
					      ...
					      <p class="mb-4 card-subtitle">
					       ...
					       <a href="{{ url('/detailPrestasi/'.$prestasi->id) }}" class="btn p-3 rounded-circle shadow"><span class="lead font-weight-bold">Detail <i class="fas fa-external-link-alt"></i></span></a>
					    </div>
					  </div> {{-- end card --}}
					</div>
				@endforeach
			</div> {{-- end prestasi row --}}
			<a href="{{ url('/') }}" class="btn btn-dark rounded-pill px-5 shadow text-white"><span class="lead font-weight-bold">BACK TO HOME <i class="fas fa-home"></i></span></a>
		</div>
